# EXECUTIVE SUMMARY
## ("Hadi Awang" OR "Abdul Hadi") AND (Bersatu OR Muhyiddin OR "kesabaran ada batas")
...
- **Threads**: 454 posts (Avg Sentiment: 0.34)
- **Tiktok**: 347 posts (Avg Sentiment: 0.52)
- **Facebook**: 45 posts (Avg Sentiment: 0.33)

---

## 🔥 TOP INSIGHTS

1. Analyzed 846 data points across 3 platforms
2. Statistical confidence: Limited (45%)
3. Overall sentiment: Neutral (±±15-25%)
4. Total engagement: 9,303,043 interactions
...
**Report Generated:** 2026-05-29 19:47:01
