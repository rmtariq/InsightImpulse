...
(function () {
  ...
  const STATE_CFG = {
    N9: {
      ...
      intelTitle: "Tugasan — 23 Kerusi PAS",
      intelDesc: "16 wajib + 7 imbang · matriks keutamaan · klik kerusi untuk checklist taktikal penuh",
    },
    Johor: {
      label: "Johor",
      dun: 56,
      ...
      issueTitle: "Isu Panas (Semua Platform)",
      intelTitle: "Intel Kerusi — PRN Johor",
      intelDesc: "56 DUN · socmed + senario live · klik kerusi di modul DUN",
    },
    Melaka: {
      label: "Melaka",
      dun: 28,
      ...
      intelTitle: "Intel Kerusi — PRN Melaka",
      intelDesc: "28 DUN · modul DUN untuk drill-down",
    },
  };
