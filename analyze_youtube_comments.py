...
csv_file = sys.argv[1] if len(sys.argv) > 1 else 'data/combined/Combined_youtube_20260529_112006.csv'
...
print(f"\n✅ Parent-child linking is working for YouTube!")
