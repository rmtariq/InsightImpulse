...
csv_file = sys.argv[1] if len(sys.argv) > 1 else 'data/combined/Combined_tiktok_20260529_110658.csv'
...
for parent_id in posts_with_comments:
    ...
    parent_post = posts[posts['URL'].str.contains(str(parent_id), na=False)]
...
print(f"\n✅ Parent-child linking is working for TikTok!")
