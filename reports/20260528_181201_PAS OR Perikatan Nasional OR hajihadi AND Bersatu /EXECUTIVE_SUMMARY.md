# EXECUTIVE SUMMARY
## ("PAS" OR "Perikatan Nasional" OR "hajihadi") AND ("Bersatu" OR "Muhyiddin")
...
- **Threads**: 20 posts (Avg Sentiment: 0.50)

---

## 🔥 TOP INSIGHTS

1. Analyzed 20 data points across 1 platforms
2. Statistical confidence: Limited (45%)
3. Overall sentiment: Neutral (±±15-25%)
4. Total engagement: 26,826 interactions
...
**Report Generated:** 2026-05-28 18:12:01
